...
var Button = (_a) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    ...
    __spreadProps(__spreadValues(__spreadValues({
      ...
      children: [
        icon && iconPosition === "left" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SvgIcon, { component: icon }),
        children,
        icon && iconPosition === "right" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SvgIcon, { component: icon })
      ]
    })
  );
};
